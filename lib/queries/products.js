...
export async function addProduct(data) {
  const {
    ...
    slug, short_description, image_url, in_stock, is_featured, is_gift, category, price_range, notes, texture
  } = data;
  ...
  return await sql`
    INSERT INTO products (
      name, base_type, weight_grams, unit_price, is_seasonal, ingredients,
      slug, short_description, image_url, in_stock, is_featured, is_gift, category, price_range,
