...
export async function addProduct(data) {
  const {
    ...
    slug, short_description, mini_label_description, image_url, in_stock, is_wholesale_eligible, is_featured, is_gift, category, price_range, notes, texture
  } = data;
  ...
  return await sql`
    INSERT INTO products (
      name, base_type, weight_grams, unit_price, is_seasonal, ingredients,
      slug, short_description, mini_label_description, image_url, in_stock, is_wholesale_eligible, is_featured, is_gift, category, price_range,
...
export async function updateProduct(id, data) {
  ...
  return await sql`
    ...
    SET
      ...
      mini_label_description = ${mini_label_description},
      image_url = ${image_url},
      in_stock = ${in_stock},
