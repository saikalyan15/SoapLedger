...
export const UI = {
  en: {
    ...
    ethosBody:
      'Healing Soil soaps are made in small batches in Goa. We use simple, natural ingredients: essential oils, sun-dried herbs, fruit peels and flowers, infused into goat milk and glycerin soap bases sourced from verified suppliers. Our soaps have no SLS, no parabens, no synthetic fragrance and no artificial colours.',
  ...
  hi: {
    ...
    ethosBody:
      'हीलिंग सॉइल के साबुन गोवा में छोटे-छोटे बैच में बनाए जाते हैं। हम सरल, प्राकृतिक सामग्री का इस्तेमाल करते हैं: एसेंशियल ऑयल, धूप में सुखाई हुई जड़ी-बूटियाँ, फलों के छिलके और फूल, जिन्हें सत्यापित आपूर्तिकर्ताओं से मंगाए गए बकरी के दूध और ग्लिसरीन साबुन बेस में मिलाया जाता है। हमारे साबुन में कोई SLS नहीं, कोई पैराबेन नहीं, कोई कृत्रिम सुगंध नहीं और कोई कृत्रिम रंग नहीं।',
    ingredients: 'सामग्री',
    weight: '50 ग्राम बार',
    price: 'मूल्य',
  ...
  kn: {
    ...
    ethosBody:
      'ಹೀಲಿಂಗ್ ಸಾಯಿಲ್ ಸೋಪುಗಳನ್ನು ಗೋವಾದಲ್ಲಿ ಸಣ್ಣ ಬ್ಯಾಚ್‌ಗಳಲ್ಲಿ ತಯಾರಿಸಲಾಗುತ್ತದೆ. ನಾವು ಸರಳ, ನೈಸರ್ಗಿಕ ಪದಾರ್ಥಗಳನ್ನು ಬಳಸುತ್ತೇವೆ: ಎಸೆನ್ಷಿಯಲ್ ಆಯಿಲ್‌ಗಳು, ಬಿಸಿಲಿನಲ್ಲಿ ಒಣಗಿಸಿದ ಗಿಡಮೂಲಿಕೆಗಳು, ಹಣ್ಣಿನ ಸಿಪ್ಪೆಗಳು ಮತ್ತು ಹೂವುಗಳು. ಇವುಗಳನ್ನು ಪರಿಶೀಲಿಸಿದ ಪೂರೈಕೆದಾರರಿಂದ ತರಿಸಿದ ಮೇಕೆ ಹಾಲು ಮತ್ತು ಗ್ಲಿಸರಿನ್ ಸೋಪ್ ಬೇಸ್‌ನಲ್ಲಿ ಬೆರೆಸಲಾಗುತ್ತದೆ. ನಮ್ಮ ಸೋಪುಗಳಲ್ಲಿ SLS ಇಲ್ಲ, ಪ್ಯಾರಬೆನ್ ಇಲ್ಲ, ಕೃತಕ ಸುಗಂಧ ಇಲ್ಲ ಮತ್ತು ಕೃತಕ ಬಣ್ಣ ಇಲ್ಲ.',
